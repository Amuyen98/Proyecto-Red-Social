const urlBase = "https://jsonplaceholder.typicode.com/posts"; //URL con la cual vamos a  interactuar
let posts = []; //Iniciamos los posteos en un array vaío
...
function deletePost(id){
  ...
  .then(res => {
    if(res.ok){
      ...
      alert('Error al Borrar Posteo')
    }
  })
  .catch((error) => console.error("Error al Borrar Posteo: ", error));
}